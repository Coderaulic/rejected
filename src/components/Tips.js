		...
		return (
			<div className='col-lg pt4'>
				<div className='lead'>
					...
					<span>I highly recommend <a href='https://leetcode.com/' target='_.blank'>LeetCode.</a> I've recognized many questions from there in the many on-site interviews I've done. Seriously though, there are tons of resources out there to improve your coding skills.</span>
				</div>
			</div>
		);
	};
